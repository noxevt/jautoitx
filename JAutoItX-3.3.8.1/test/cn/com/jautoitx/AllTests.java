...
@Suite.SuiteClasses({ AutoItXTest.class, ClipTest.class,
		...
		IniTest.class, KeyboardTest.class, ListViewTest.class, MiscTest.class,
		MouseTest.class, OptTest.class, PixelTest.class, ProcessTest.class,
		RegTest.class, TitleBuilderTest.class, TreeViewTest.class,
		Win32Test.class, WinTest.class })
