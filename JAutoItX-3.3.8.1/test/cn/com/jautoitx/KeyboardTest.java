...
public class KeyboardTest extends BaseTest {
	...
	public void send() throws IOException {
		...
		try {
			...
			Assert.assertEquals("1234567890ÄãºÃ",
					FileUtils.readFileToString(file, "GBK"));
			...
			sleep(500);
			Assert.assertTrue(file.exists());
			Assert.assertEquals("@#", FileUtils.readFileToString(file, "GBK"));
			Assert.assertTrue(file.delete());
			...
			sleep(500);
			Assert.assertTrue(file.exists());
			Assert.assertEquals("+2+3", FileUtils.readFileToString(file, "GBK"));
			Assert.assertTrue(file.delete());
