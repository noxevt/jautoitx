...
public class ControlTest extends BaseTest {
	...
	public void findString() {
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				String[] items = new String[] { "Java", "JAVA", "Lisp", "Ò×ÓïÑÔ",
		...
		try {
			...
			for (String control : new String[] { "ComboBox1", "ListBox1" }) {
				...
				assertEquals(3, Control.findString(title, control, "Ò×ÓïÑÔ"));
				...
				assertEquals(2, Control.findString(title, control, "Ò×ÓïÑÔ"));
	...
	public void getString() {
		...
		Thread thread = new Thread(new Runnable() {
			...
			public void run() {
				...
				String[] items = new String[] { "Java", "Lisp", "Ò×ÓïÑÔ", "",
						"Tcl", "Smalltalk" };
		...
		try {
			...
			for (String control : new String[] { "ComboBox1", "ListBox1" }) {
				...
				assertEquals("Ò×ÓïÑÔ", Control.getString(title, control, 2));
				...
				Assert.assertNull(Control.getString(title, control, -1));
				assertEquals("Java", Control.getString(title, control, 0));
				assertEquals("Ò×ÓïÑÔ", Control.getString(title, control, 1));
	...
	public void getStringList() {
		...
		try {
			...
			for (String control : new String[] { "ComboBox1", "ListBox1" }) {
				...
				assertEquals("Ò×ÓïÑÔ", list.get(2));
				...
				assertEquals(6, list.size());
				assertEquals("Java", list.get(0));
				assertEquals("Ò×ÓïÑÔ", list.get(1));
	...
	public void setCurrentSelection() {
		...
		try {
			...
			for (String control : new String[] { "ComboBox1", "ListBox1" }) {
				...
				assertEquals("Ò×ÓïÑÔ", Control.getCurrentSelection(title, control));
				Assert.assertTrue(Control
	...
	public void selectString() {
		...
		final String[] items = new String[] { "Java", "Lisp", "Ò×ÓïÑÔ", "", "Tcl",
				"Smalltalk" };
