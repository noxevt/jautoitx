...
public class IniTest extends BaseTest {
	...
	public void delete() throws IOException {
		...
		Ini.delete(new File("test/iniDelete.ini").getAbsolutePath(),
				"SectionName");
		assertFileContentEquals("test/iniDelete_3.ini", "test/iniDelete.ini");
	...
	public void read() throws IOException {
		...
		Assert.assertEquals("Value3",
				Ini.read("test/iniDelete.tmp", "SectionName2", "Key3", null));
		Assert.assertEquals("Value",
				Ini.read("test/iniDelete.tmp", "SectionName", "Key", null));
		Assert.assertEquals("",
				Ini.read("test/iniDelete.tmp", "NotExistsSection", "Key", null));
		Assert.assertEquals("", Ini.read("test/iniDelete.tmp", "SectionName",
				"NotExistsKey", null));
		...
		Assert.assertEquals("Value",
				Ini.read("test/iniDelete.tmp", "SectionName", "Key", null));
		Assert.assertEquals("NoSection", Ini.read("test/iniDelete.tmp",
				"NotExistsSection", "Key", "NoSection"));
		Assert.assertEquals("NoKey", Ini.read("test/iniDelete.tmp",
				"SectionName", "NotExistsKey", "NoKey"));
	}
